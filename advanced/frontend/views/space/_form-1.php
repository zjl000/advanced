 ...
 <div class="form">
 	<?php $form = ActiveForm::begin([
		...
		<div class="upload">
			<?= Html::tag('label', '作品封面') ?>	
			<div class="pic">
		    	<?= Html::img('images/cover_default.png', ['alt'=>'封面图片', 'id'=>'revImg']) ?>
		    </div>
			<div class="explain">
		...
		<div class="tag">
			<?= Html::tag('label', '标签') ?>
			<?= Html::a('添加', 'javascript:;', ['class'=>'btn btn-info', 'id'=>'tags'] ) ?>
			<?= Html::tag('span', '', ['class'=>'empty']) ?>
		...
		<?= $form->field($model, 'publication')->dropDownList(['0'=>'未出版', '1'=>'已出版'],['style'=>'width:200px']) ?>
...
<div class="uploadFile" id="uploadFile">
	...
	<div id="shearphoto_main">
		...
		<div class="Effects" id="shearphoto_Effects" autocomplete="off">
			...
			<a href="javascript:;" StrEvent="原图" class="Aclick"><img src="images/Effects/e0.jpg" />原图</a>
			<a href="javascript:;" StrEvent="美肤"><img src="images/Effects/e1.jpg" />美肤效果</a>
			<a href="javascript:;" StrEvent="素描"><img src="images/Effects/e2.jpg" />素描效果</a>
			<a href="javascript:;" StrEvent="自然增强"><img src="images/Effects/e3.jpg" />自然增强</a>
			<a href="javascript:;" StrEvent="紫调"><img src="images/Effects/e4.jpg" />紫调效果</a>
			<a href="javascript:;" StrEvent="柔焦"><img src="images/Effects/e5.jpg" />柔焦效果</a>
			<a href="javascript:;" StrEvent="复古"><img src="images/Effects/e6.jpg" />复古效果</a>
			<a href="javascript:;" StrEvent="黑白"><img src="images/Effects/e7.jpg" />黑白效果</a>
			<a href="javascript:;" StrEvent="仿lomo"><img src="images/Effects/e8.jpg" />仿lomo</a>
			<a href="javascript:;" StrEvent="亮白增强"><img src="images/Effects/e9.jpg" />亮白增强</a>
			<a href="javascript:;" StrEvent="灰白"><img src="images/Effects/e10.jpg" />灰白效果</a>
			<a href="javascript:;" StrEvent="灰色"><img src="images/Effects/e11.jpg" />灰色效果</a>
			<a href="javascript:;" StrEvent="暖秋"><img src="images/Effects/e12.jpg" />暖秋效果</a>
			<a href="javascript:;" StrEvent="木雕"><img src="images/Effects/e13.jpg" />木雕效果</a>
			<a href="javascript:;" StrEvent="粗糙"><img src="images/Effects/e14.jpg" />粗糙效果</a>
		</div>
		<!--效果结束...........................如果你不要特效，可以直接删了.....................................................-->
		<!--primary范围开始-->
		<div class="primary">
