                    ...
                    <div class="c_frame">
                        <form>
                            ...
                            <table width="100%" cellpadding=0 cellspacing=0>
                                <tr>
                                    <td class="vt col1">
                                        <a id="comment_face" class="show-emotion" onclick="showFace(this.id, 'content');return false;" href="javascript:;" title="插入表情"></a>
                                    </td>
                                    <td class="vt col2">                                                                
                            ...
                            <li class="J_ItemLi">
                                ...
                                <?php if($v['authorid'] != 0){ ?>
                                    <div class="head-pic2">
                                        ...
                                        <a class="c_author" href="home.php?mod=space&amp;uid=1" target="_blank"><?= \YII::$app->params['username'] ?></a>
                                    </div>
                                    <p class="c_desc">
                                        <span style="display: block;">回复<a href="home.php?mod=space&uid=2" style="color:#327d99"><?= $v['user']['username']; ?></a>：</span>
                                        <?= $v['message']; ?>
                                    </p>
                                <?php }else{ ?>
                                    <div class="head-pic2">
                                ...
                                <p class="c_act">
                                    ...
                                    <?php }else{ ?>
                                        <a key="<?= $v['replyid'] ?>" onclick="d_nologin()" href="javascript:;">删除</a>
                                    <?php } ?>
                                    <!--<a href="#">举报</a>-->
                                    <!-- 评论用户ID -->
