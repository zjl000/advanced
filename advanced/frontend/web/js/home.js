...
function showFace(showid, target, dropstr) {
	...
	if($(showid + '_menu') != null) {
		...
		for(i=1; i<101; i++) {
			...
			faceli.innerHTML = '<img src="' + STATICURL + 'images/smiley/'+i+'.gif" onclick="insertFace(\''+showid+'\','+i+', \''+ target +'\', \''+dropstr+'\')" style="cursor:pointer; position:relative;" />';
